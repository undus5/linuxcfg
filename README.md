...
(user)$ ln -s ~/a/config/* ~/.config/
(user)$ ln -s ~/a/local.share/fonts ~/.local/share/
(user)$ ln -s ~/a/local.share/icons ~/.local/share/
(user)$ cp -r ~/a/local.share/entries ~/.local/share/applications/
